...
public class RequestManagerTest {
    ...
    @Autowired
    private RequestManager requestManagerTest;

    private final String recipient_email = "test_email";
    private final String event_type = "REQUEST";
    ...
    public void validEvent() throws InterruptedException, ExecutionException, MissingAttributeException {
        ...
        requestManagerTest.setData(data);
        requestManagerTest.sendNotification();

        // send notification and test the published notification if it's correct
        WebNotification webNotification = requestManagerTest.getWn();
        ...
        EmailNotification emailNotification = requestManagerTest.getEn();
        String email_subject = "New Contract Request";
