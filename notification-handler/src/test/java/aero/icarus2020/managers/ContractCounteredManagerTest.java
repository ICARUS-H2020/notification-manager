...
@SpringBootTest
public class ContractCounteredManagerTest {
    @MockBean
    ...
    @Autowired
    private ContractCounteredManager contractCounteredManagerTest;

    private final String recipient_email = "test_email";
    private final String event_type = "CONTRACT_COUNTERED";
    ...
    public void validEvent() throws InterruptedException, ExecutionException, MissingAttributeException {
        ...
        contractCounteredManagerTest.setData(data);
        contractCounteredManagerTest.sendNotification();

        // send notification and test the published notification if it's correct
        WebNotification webNotification = contractCounteredManagerTest.getWn();
        ...
        EmailNotification emailNotification = contractCounteredManagerTest.getEn();
        String email_subject = "Contract Countered";
