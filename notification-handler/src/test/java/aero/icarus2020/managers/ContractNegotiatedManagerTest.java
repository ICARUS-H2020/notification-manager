...
@SpringBootTest
public class ContractNegotiatedManagerTest {
    @MockBean
    ...
    @Autowired
    private ContractNegotiatedManager contractNegotiatedManagerTest;

    private final String recipient_email = "test_email";
    private final String event_type = "CONTRACT_NEGOTIATED";
    ...
    public void validEvent() throws InterruptedException, ExecutionException, MissingAttributeException {
        ...
        contractNegotiatedManagerTest.setData(data);
        contractNegotiatedManagerTest.sendNotification();

        // send notification and test the published notification if it's correct
        WebNotification webNotification = contractNegotiatedManagerTest.getWn();
        ...
        EmailNotification emailNotification = contractNegotiatedManagerTest.getEn();
        String email_subject = "Contract Negotiated";
