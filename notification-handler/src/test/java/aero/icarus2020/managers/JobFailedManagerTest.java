...
@SpringBootTest
public class JobFailedManagerTest {
    @MockBean
    ...
    @Autowired
    private JobFailedManager jobFailedManagerTest;

    private final String recipient_email = "test_email";
    private final String event_type = "JOB_FAILED";
    ...
    public void validEvent() throws InterruptedException, ExecutionException, MissingAttributeException {
        ...
        jobFailedManagerTest.setData(data);
        jobFailedManagerTest.sendNotification();

        // send notification and test the published notification if it's correct
        WebNotification webNotification = jobFailedManagerTest.getWn();
        ...
        EmailNotification emailNotification = jobFailedManagerTest.getEn();
        String email_subject = "Analytics Job Failed";
