...
@SpringBootTest
public class ContractOfferedManagerTest {
    @MockBean
    ...
    @Autowired
    private ContractOfferedManager contractOfferedManagerTest;

    private final String recipient_email = "test_email";
    private final String event_type = "CONTRACT_OFFERED";
    ...
    public void validEvent() throws InterruptedException, ExecutionException, MissingAttributeException {
        ...
        contractOfferedManagerTest.setData(data);
        contractOfferedManagerTest.sendNotification();

        // send notification and test the published notification if it's correct
        WebNotification webNotification = contractOfferedManagerTest.getWn();
        ...
        EmailNotification emailNotification = contractOfferedManagerTest.getEn();
        String email_subject = "Contract Offered";
