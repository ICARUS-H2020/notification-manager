...
@SpringBootTest
public class ContractOfferAcceptedManagerTest {
    @MockBean
    ...
    @Autowired
    private ContractOfferAcceptedManager contractOfferAcceptedManagerTest;

    private final String recipient_email = "test_email";
    private final String event_type = "CONTRACT_OFFER_ACCEPTED";
    ...
    public void setUp() throws InterruptedException {
        ...
        ownerOrg.setId(Long.parseLong(applicantID));
    ...
    public void validEvent() throws InterruptedException, ExecutionException, MissingAttributeException {
        ...
        // set up applicant organization for this test
        ...
        applicantOrg.setManager(orgMan);
        ...
        contractOfferAcceptedManagerTest.setData(data);
        contractOfferAcceptedManagerTest.sendNotification();

        // send notification and test the published notification if it's correct
        WebNotification webNotification = contractOfferAcceptedManagerTest.getWn();
        ...
        EmailNotification emailNotification = contractOfferAcceptedManagerTest.getEn();
        String email_subject = "Contract Offer Accepted";
    ...
    /**
     * Create a valid event, and check that it will only publish an Email event.
     *
     * @throws InterruptedException
     * @throws ExecutionException
     * @throws MissingAttributeException
    ...
    public void invalidEvent() {
        // ContractAcceptedManager contractAcceptedManagerTest = new ContractAcceptedManager();
