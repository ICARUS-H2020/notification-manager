...
@SpringBootTest
public class ContractRejectedManagerTest {
    @MockBean
    ...
    @Autowired
    private ContractRejectedManager contractRejectedManagerTest;

    private final String recipient_email = "test_email";
    private final String event_type = "CONTRACT_REJECTED";
    ...
    public void validEvent() throws InterruptedException, ExecutionException, MissingAttributeException {
        ...
        contractRejectedManagerTest.setData(data);
        contractRejectedManagerTest.sendNotification();

        // send notification and test the published notification if it's correct
        WebNotification webNotification = contractRejectedManagerTest.getWn();
        ...
        EmailNotification emailNotification = contractRejectedManagerTest.getEn();
        String email_subject = "Contract Rejected";
    ...
    /**
     * Create a valid event, and check that it will publish the only an Email event.
     *
     * @throws InterruptedException
     * @throws ExecutionException
     * @throws MissingAttributeException
    ...
    /**
     * Create a valid event, and check that it will publish the only a Notification event.
     *
     * @throws InterruptedException
     * @throws ExecutionException
     * @throws MissingAttributeException
    ...
    /**
     * Create a valid event, and check that it will not publish neither a Notification or Email events.
     *
     * @throws InterruptedException
     * @throws ExecutionException
     * @throws MissingAttributeException
