...
@SpringBootTest
public class SuggestionAcceptedManagerTest {
    @MockBean
    ...
    @Autowired
    private SuggestionAcceptedManager suggestionAcceptedManagerTest;

    private final String recipient_email = "test_email";
    private final String event_type = "SUGGESTION_ACCEPTED";
    ...
    public void validEvent() throws InterruptedException, ExecutionException, MissingAttributeException {
        ...
        suggestionAcceptedManagerTest.setData(data);
        suggestionAcceptedManagerTest.sendNotification();

        // send notification and test the published notification if it's correct
        WebNotification webNotification = suggestionAcceptedManagerTest.getWn();
        ...
        EmailNotification emailNotification = suggestionAcceptedManagerTest.getEn();
        String email_subject = "Concept Suggestion Accepted";
