...
@SpringBootTest
public class ContractOfferRejectedManagerTest {
    @MockBean
    ...
    @Autowired
    private ContractOfferRejectedManager contractOfferRejectedManagerTest;

    private final String recipient_email = "test_email";
    private final String event_type = "CONTRACT_OFFER_REJECTED";
    ...
    public void validEvent() throws InterruptedException, ExecutionException, MissingAttributeException {
        ...
        contractOfferRejectedManagerTest.setData(data);
        contractOfferRejectedManagerTest.sendNotification();

        // send notification and test the published notification if it's correct
        WebNotification webNotification = contractOfferRejectedManagerTest.getWn();
        ...
        EmailNotification emailNotification = contractOfferRejectedManagerTest.getEn();
        String email_subject = "Contract Offer Rejected";
