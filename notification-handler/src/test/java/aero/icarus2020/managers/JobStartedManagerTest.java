...
@SpringBootTest
public class JobStartedManagerTest {
    @MockBean
    ...
    @Autowired
    private JobStartedManager jobStartedManagerTest;

    private final String recipient_email = "test_email";
    private final String event_type = "JOB_STARTED";
    ...
    public void validEvent() throws InterruptedException, ExecutionException, MissingAttributeException {
        ...
        jobStartedManagerTest.setData(data);
        jobStartedManagerTest.sendNotification();

        // send notification and test the published notification if it's correct
        WebNotification webNotification = jobStartedManagerTest.getWn();
        ...
        EmailNotification emailNotification = jobStartedManagerTest.getEn();
        String email_subject = "Analytics Job Started";
