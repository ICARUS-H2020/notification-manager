...
public class OtherManagerTest {
    ...
    @Autowired
    private OtherManager otherManagerTest;

    private final String recipient_email = "test_email";
    private final String event_type = "OTHER";
    private final String title = "Test";
    private final String body = "Testing Other Event";
    private final String targetType = "other";
    private final String targetId = "3";
    private final String recipientId = "40";
    ...
    public void setUp() throws InterruptedException {
        ...
        user.setId(Long.valueOf(recipientId));
        when(service.getUser(recipientId)).thenReturn(CompletableFuture.completedFuture(user));
    ...
    public void validEvent() throws InterruptedException, ExecutionException, MissingAttributeException {
        ...
        otherManagerTest.setData(data);
        otherManagerTest.sendNotification();

        // send notification and test the published notification if it's correct
        WebNotification webNotification = otherManagerTest.getWn();
        ...
        assertEquals("Notification Receiver", recipientId, String.valueOf(webNotification.getRecipient_id()));
        ...
        EmailNotification emailNotification = otherManagerTest.getEn();
        assertEquals("Email Subject", title, emailNotification.getSubject());
