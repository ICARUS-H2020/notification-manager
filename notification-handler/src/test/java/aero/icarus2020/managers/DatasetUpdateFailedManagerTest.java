...
@SpringBootTest
public class DatasetUpdateFailedManagerTest {
    @MockBean
    ...
    @Autowired
    private DatasetUpdateFailedManager datasetUpdateFailedManagerTest;

    private final String recipient_email = "test_email";
    private final String event_type = "DATA_ASSET_UPDATE_FAILED";
    ...
    public void validEvent() throws InterruptedException, ExecutionException, MissingAttributeException {
        ...
        datasetUpdateFailedManagerTest.setData(data);
        datasetUpdateFailedManagerTest.sendNotification();

        // send notification and test the published notification if it's correct
        WebNotification webNotification = datasetUpdateFailedManagerTest.getWn();
        ...
        EmailNotification emailNotification = datasetUpdateFailedManagerTest.getEn();
        String email_subject = "Data Asset Update Failed";
