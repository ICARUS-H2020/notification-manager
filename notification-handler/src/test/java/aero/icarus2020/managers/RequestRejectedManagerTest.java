...
@SpringBootTest
public class RequestRejectedManagerTest {
    @MockBean
    ...
    @Autowired
    private RequestRejectedManager requestRejectedManagerTest;

    private final String recipient_email = "test_email";
    private final String event_type = "REQUEST_REJECTED";
    ...
    public void validEvent() throws InterruptedException, ExecutionException, MissingAttributeException {
        ...
        requestRejectedManagerTest.setData(data);
        requestRejectedManagerTest.sendNotification();

        // send notification and test the published notification if it's correct
        WebNotification webNotification = requestRejectedManagerTest.getWn();
        ...
        EmailNotification emailNotification = requestRejectedManagerTest.getEn();
        String email_subject = "Request Rejected";
