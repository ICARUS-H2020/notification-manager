...
@Service
public class ContractCounteredManager extends Manager {
    ...
    public void sendNotification() throws InterruptedException, ExecutionException, MissingAttributeException {
        System.out.println("Processing 'contract countered' event...");
        wn = null;
        en = null;
            ...
            if (notifications != null)
                for (NotificationsDao notification : notifications)
                    if (notification.getLabel().compareToIgnoreCase("contracts") == 0) {
                        ...
                        buildNotification(notification, orgMan, meta, content, "CONTRACT_COUNTERED", "Contract Countered");
                        break;
                    }
        }

        System.out.println("Processing 'contract countered' event...done");
    }
