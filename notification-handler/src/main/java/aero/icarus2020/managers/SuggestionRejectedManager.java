...
@Service
public class SuggestionRejectedManager extends Manager {
    ...
    public void sendNotification() throws InterruptedException, ExecutionException, MissingAttributeException {
        System.out.println("Processing 'suggestion rejected' event...");
        ...
        buildNotification(notification, recipientId, meta, content, "SUGGESTION_REJECTED", "Concept Suggestion Rejected");

        System.out.println("Processing 'suggestion rejected' event...done");
    }
