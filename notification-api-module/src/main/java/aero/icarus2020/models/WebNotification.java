...
public class WebNotification {
    ...
    @Column(name = "seen_on")
    private Timestamp seen_on;

    @Column(name = "_created_on")
    private Timestamp _created_on;
    ...
    public Timestamp getSeen_on() {
        return seen_on;
    }

    public void setSeen_on(Timestamp seen_on) {
        this.seen_on = seen_on;
    }

    public Timestamp get_created_on() {
        return _created_on;
    }

    public void set_created_on(Timestamp _created_on) {
